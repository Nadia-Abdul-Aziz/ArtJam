...
//Loading images
function preload() {
    soccerBall = loadImage('/ArtJam/tree/main/SOCCER-PONG/assets/images/soccerBall.png');
    soccerNet = loadImage('/ArtJam/tree/main/SOCCER-PONG/assets/images/soccerNet.png');
    Goal = loadImage('/ArtJam/tree/main/SOCCER-PONG/assets/images/Goal.png');
    gameOverTxt = loadImage('/ArtJam/tree/main/SOCCER-PONG/assets/images/gameOver.png');
};
